...
export function dataTo64SVG(data: string) {
   return `data:image/svg+xml;base64,${btoa(buildSVG([{ data }], ImageData.palette/*, "ccaa55" OPTIONAL BG */))}`;
}
...
export const filenameToHumanReadable = new Map([
   ...
   ["accessory-body-gradient-checkerdisco", "Body Gradient Checkerdisco"],
   ["accessory-body-gradient-dawn", "Body Gradient Dawn"],
   ["accessory-body-gradient-dusk", "Body Gradient Dusk"],
   ["accessory-body-gradient-glacier", "Body Gradient Glacier"],
   ["accessory-body-gradient-ice", "Body Gradient Ice"],
   ["accessory-body-gradient-pride", "Body Gradient Pride"],
   ["accessory-body-gradient-redpink", "Body Gradient Redpink"],
   ["accessory-body-gradient-sunset", "Body Gradient Sunset"],
   ["accessory-carrot", "Carrot"],
   ["accessory-chain-logo", "Chain Logo"],
   ["accessory-checker-RGB", "Checker RGB"],
   ["accessory-checker-bigwalk-blue-prime", "Checker Bigwalk Blue Prime"],
   ["accessory-checker-bigwalk-greylight", "Checker Bigwalk Greylight"],
   ["accessory-checker-bigwalk-rainbow", "Checker Bigwalk Rainbow"],
   ...
   ["accessory-txt-a2+b2", "Txt A2+b2"],
   ["accessory-txt-cc", "Txt Cc"],
   ["accessory-txt-cc2", "Txt Cc2"],
   ["accessory-txt-copy", "Txt Copy"],
   ["accessory-txt-dao-black", "Txt Dao Black"],
   ["accessory-txt-doom", "Txt Doom"],
   ["accessory-txt-dope-text", "Txt Dope Text"],
   ["accessory-txt-foo-black", "Txt Foo Black"],
   ["accessory-txt-ico", "Txt Ico"],
   ["accessory-txt-io", "Txt Io"],
   ["accessory-txt-lmao", "Txt Lmao"],
   ["accessory-txt-lol", "Txt Lol"],
   ["accessory-txt-mint", "Txt Mint"],
   ["accessory-txt-nil-grey-dark", "Txt Nil Grey Dark"],
   ["accessory-txt-noun-f0f", "Txt Noun F0f"],
   ["accessory-txt-noun-green", "Txt Noun Green"],
   ["accessory-txt-noun-multicolor", "Txt Noun Multicolor"],
   ["accessory-txt-noun", "Txt Noun"],
   ["accessory-txt-pi", "Txt Pi"],
   ["accessory-txt-pop", "Txt Pop"],
   ["accessory-txt-rofl", "Txt Rofl"],
   ["accessory-txt-we", "Txt We"],
   ["accessory-txt-yay", "Txt Yay"],
   ["accessory-wall", "Wall"],
   ["accessory-wave", "Wave"],
   ...
   ["head-cassettetape", "Cassettetape"],
   ["head-cat", "Cat"],
   ["head-cd", "Cd"],
   ["head-chain", "Chain"],
   ...
   ["head-cookie", "Cookie"],
   ["head-cordlessphone", "Cordlessphone"],
   ...
   ["head-tooth", "Tooth"],
   ["head-toothbrush-fresh", "Toothbrush Fresh"],
...
export const categories:{name: string, traits:PartType[]}[] = [
   ...
   { name: "Backgrounds", traits: [{svg: getBackgroundSVG(0), name: "Cool", filename:"bg-cool" }, {svg: getBackgroundSVG(1), name: "Warm", filename:"bg-warm"}]}
]
